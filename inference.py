	...
	if args.box[0] == -1:
		if not args.static:
			...
			while i < len(frames):
				...
				faces = faceCascade.detectMultiScale(image, 1.1, 10)
				if box != []:				
					#a = frames[i][result[0]['box'][1]-100:result[0]['box'][1]+result[0]['box'][3]+100, result[0]['box'][0]-100:result[0]['box'][0]+result[0]['box'][2]+100]
					a = frames[i][faces[0][1]:faces[0][1]+ faces[0][2], faces[0][0]:faces[0][0] + faces[0][3]]
					c = 0
					while c < threshold:
						#face_det_results.append((result[0]['box'][1]-100, result[0]['box'][1] + result[0]['box'][3]+100, result[0]['box'][0]-100, result[0]['box'][0] + result[0]['box'][2]+100))
						face_det_results.append((faces[0][1],faces[0][1]+ faces[0][2], faces[0][0],faces[0][0] + faces[0][3]))
						cropped.append(a)
						c += 1
				else:
					c = 0
			...
			#result = detector.detect_faces(image)
			_,box,conf=face.face_detection(frame_arr=image,model='tiny')
			#face_det_results.append([result[0]['box'][1], result[0]['box'][1] + result[0]['box'][3], result[0]['box'][0], result[0]['box'][0] + result[0]['box'][2]])
			face_det_results.append((box[0][1],box[0][1]+ box[0][2], box[0][0],box[0][0] + box[0][3]))
			a = frames[0][box[0][1]:box[0][1]+ box[0][2], box[0][0]:box[0][0] + box[0][3]]
